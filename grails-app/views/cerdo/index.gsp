		...
		<div id="list-cerdo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'cerdo.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${cerdoInstanceList}" status="i" var="cerdoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cerdoInstance.id}">${fieldValue(bean: cerdoInstance, field: "nombre")}</g:link></td>
